    ...
    return (
        <div className={BusinessRegistrationStyle.Business}>
            <div className={ManagerRegistrationStyle.Header}>
                ...
                <p className={ManagerRegistrationStyle.SubTitle}>הפרטים בדף זה הם של העסק שלך.</p>
            </div>
            ...
            <div className={ManagerRegistrationStyle.Body}>
                ...
                <div className={ManagerRegistrationStyle.Field}>
                    ...
                    <textarea id="about" name="about" value={props.values.about} style={{ height: '100px' }}
                ...
                <div className={BusinessRegistrationStyle.Links}>
                    <div className={BusinessRegistrationStyle.Link}>
                        <AiOutlineLink />
                        <input type="url" name="website" id="website" value={props.values.socialMediaLinks['website']} placeholder=" אתר העסק"
                            onChange={(e) => changeLinks(e, 'website')} />
                    </div>

                    <div className={BusinessRegistrationStyle.Link}>
                        <FaFacebookF />
                        <input type="url" name="facebook" id="facebook" value={props.values.socialMediaLinks['facebook']} placeholder=" פייסבוק"
                            onChange={(e) => changeLinks(e, 'facebook')} />
                    </div>

                    <div className={BusinessRegistrationStyle.Link}>
                        <FaInstagram />
                        <input type="url" name="instagram" id="instagram" value={props.values.socialMediaLinks['instagram']} placeholder=" אינסטגרם"
